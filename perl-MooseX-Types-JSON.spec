...
cp LICENSE %{buildroot}/usr/share/package-licenses/perl-MooseX-Types-JSON/LICENSE
if test -f Makefile.PL; then
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.28.2/MooseX/Types/JSON.pm
...
/usr/share/package-licenses/perl-MooseX-Types-JSON/LICENSE
